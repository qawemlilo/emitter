...
(function (root) {  
    ...
    /* 
         Global variables 
    */
    var eventsApi, triggerEvents, Emitter, typeOf, _once, clone, isEmpty, eventsFactory;
    ...
    /*
        Helper functions
    */
    isEmpty  = root.isEmpty = function(obj) {
        if (Object.keys) {
   ...
   typeOf = root.typeOf = function (o) {
    ...
    // clones a function
    clone = root.clone = function(fn) {
        var key, newClone, Surrogate;
        ...
        Surrogate = function () {};
        Surrogate.prototype = fn.prototype;
        
        newClone.prototype = new Surrogate();
        newClone.prototype.constructor = newClone; 
